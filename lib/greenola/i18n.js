...
export const translations = {
  ar: {
    ...
    login_email_ph: "ahmed@company.com",
    ...
    pay_redirecting: "جارٍ التوجيه لبوابة الدفع...",
    pay_error: "تعذّر بدء الدفع — يرجى المحاولة مجدداً",
    pay_coming_soon: "💳 بوابة الدفع قيد التطوير — سنخبرك عند الإطلاق!",
    duration_days_label: "{days} يوم",
    plan_fallback: "خطة",
...
export function applyDocumentLocale() {
  ...
  document.querySelectorAll(".app, .phone-screen, [data-screen]").forEach((el) => {
